...
st.write("Plan your trip itinerary by entering the trip duration (number of days), destination city, \
and interests.")
...
with st.form("planner_form"):
    ...
    interests = st.text_input("Enter your (comma-separated) interests in the destination city:")
